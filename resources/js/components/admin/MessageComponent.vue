        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-right">الرسائل</h4>
                </div>
                <div class="card-body table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr v-for="msg in messages.data" v-bind:key="msg.id" :class="msg.isread == 0 ? 'bg-warning' : ''">
                            <td>{{ msg.user.name }}</td>
                            <td>{{ msg.email }}</td>
                            <td>{{ msg.type }}</td>
...
export default {
    ...
    methods: {
        getAllData() {
            axios.get(base_site + '/dashboard/messages/get').then(data => {
