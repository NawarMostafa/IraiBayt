        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" style="background:#275879;color:#ffffff;">
                    <h3 class="text-left">تعديل إعلان</h3>
                </div>
                <div class="card-body text-left">
                    <form @submit.prevent="update()" @keydown="form.onKeydown($event)">
                        ...
                        <div class="form-group row">
                            <div class="col-md-4">
                                <select v-model="form.category_id" class="form-control" @change="changeCategory"
                            ...
                            <div class="col-md-4">
                                <select v-model="form.subcat_id" class="form-control" @change="changeSubCat"
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div v-if="form.img != ''" class="col-md-2">
                                        <img v-if="form.img != '' && form.img.length > 50" class="img-thumbnail w-100"
                                            :src="form.img" alt="">
                                        <img v-else-if="form.img != '' && form.img.length < 50"
                                            class="img-thumbnail w-100" :src="base_storage + '/posts/' + form.img"
                                            alt="">
                                        <button class="btn btn-sm btn-block mt-2"
                        ...
                        <button :disabled="form.busy" type="submit" class="btn btn-primary"
                            style="background:#65aeca;">حفظ</button>
                    </form>
...
export default {
    ...
    methods: {
        changeSubCat() {
            axios.get(base_site + '/subcategories/' + this.form.subcat_id + '/get').then(({ data }) => {
                this.type = data.type;
            })
        },
        openFile1(id) {
        ...
        changeCity() {
            ...
            axios.get(base_site + '/city/region/' + this.form.city_id + '/all_list').then(({ data }) => {
                this.regions = data;
            });
        ...
        changeCategory() {
            ...
            axios.get(base_site + '/subcategories/' + this.form.category_id + '/fromCat').then(({ data }) => {
                this.subs = data;
            });
        },
        changUnit() {
    ...
    created() {
        ...
        this.getAllCurrancy();
        if (this.id_post) {
            axios.get(base_site + '/post/' + this.id_post + '/get').then(({ data }) => {
                this.form.fill(data);
