<template>
    <div class="col-md-12 row">
        <div class="col-md-12 text-left">
            <h3 class="mt-2 mb-2"><i class="fa fa-circle t-orange small"></i> <span>أنظمة وقوانين العراق</span></h3>
        </div>
...
export default {
    ...
    methods: {
        ...
        getAllData() {
            axios.get(base_site + '/getSystem').then(({ data }) => {
                this.abouts = data;
            })
        },
